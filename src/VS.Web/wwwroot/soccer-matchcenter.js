...
shotMapView.addEventListener('change',()=>{localStorage.setItem(shotMapViewKey,shotMapView.value);if(currentMatchCenter)setHtmlIfChanged(document.querySelector('#shot-map'),shotMap(currentMatchCenter,shotMapView.value));});
...
async function load() {
  ...
  setHtmlIfChanged(document.querySelector('#shot-map'), shotMap(matchCenter, shotMapView.value));
}
